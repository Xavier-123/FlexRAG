...
:class:`~flexrag.core.abstractions.BaseRetriever` strategy interface.
...
:class:`~flexrag.indexing.knowledge.FaissKnowledgeBuilder`.
...
class LlamaIndexRetriever(BaseRetriever):
    ...
    2. **From a persist directory** – call :meth:`load_index` with the path
       where :class:`~flexrag.indexing.knowledge.FaissKnowledgeBuilder` saved the index.
